...
To fill this gap, in this paper, we focus on the \textbf{historical analogy acquisition} task, which aims to acquire analogous historical events for a given event.
